 ...
 */
        ...
        btnBuscar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                buscarProducto("http://192.168.1.119/mysql_littleboss3/buscar_cliente.php?codigo="+edtCodigoc.getText()+"");
            }
        });
        ...
        btnEditar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ejecutarServicio("http://192.168.1.119/mysql_littleboss3/editar_cliente.php");
        ...
        btnEliminar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                eliminarProducto("http://192.168.1.119/mysql_littleboss3/eliminar_cliente.php");
